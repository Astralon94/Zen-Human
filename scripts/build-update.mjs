...
// come release su GitHub (repo del codice Astralon94/Zen-Human, pubblica: ospita codice E release).
// Uso:  node scripts/build-update.mjs [--note "testo"]
// Produce:  dist/zen-human-<version>.json.gz  e  dist/manifest.json
...
console.log(`  --repo Astralon94/Zen-Human --title "Zen-Human ${version}" --notes "${note || '...'}"`);
